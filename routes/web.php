...
Route::middleware(['guest'])->group(function () {
    ...
    Route::post('/register/auth/country', [UserController::class, 'Getcountry'])->name('pekat.countryGet');
    Route::post('/register/auth/kecamatan', [UserController::class, 'Getkecamatan'])->name('pekat.Getkecamatan');
    Route::post('/register/auth/kelurahan', [UserController::class, 'Getkelurahan'])->name('pekat.Getkelurahan');
